                ...
                <div className="container">
                    <div className="row">   
                        <div className="col-lg-4 col-sm-6">
                            <div className="footer--widget company_widget" >
                                <NavLink className="f-logo" to={'/'}>
                                    <img src={require("../../img/logo-blue.png")} alt="Logo DreamCode Software" width="170"/>
                                </NavLink>
                                <div className="widget-wrap mt_20 f_p f_600">
                                    <p className="f_size_18 mb-2"><span className='t_color'>{t('footer.email')}:</span> <a href="mailto:info@dreamcodesoft.com"  className="f_500 p_color">info@dreamcodesoft.com</a></p>
                                    <p className="f_size_18 mb-2"><span className='t_color'>{t('footer.phone')}:</span> <a href="tel:573155790099"  className="f_500 p_color">+57 315 220 62 11</a></p>
                                    <p className="f_size_18 mb-2"><span className='t_color'>Colombia: </span><a href="https://goo.gl/maps/Ync42KoKat2ckRW86"  className="f_500 p_color"> Carrera 100 #16-321, <br></br>{t('footer.address')}, Cali, Colombia.</a></p>
                                    <p className="f_size_18 mb-2"><span className='t_color'>USA: </span><a href="https://goo.gl/maps/DGBgT8RAojBZghKK7"  className="f_500 p_color"> 50 California Street, 15th Floor, <br></br>San Francisco, CA 94111-4701, United States. </a></p>
                                </div>
                            </div>
                        </div>
                        {       
                        ...
                        <div className="col-lg-2 col-sm">
                            <figure className="footer--widget ">
                        ...
                        itemsWidget.map((item, i) => {
                            return (
                                <li className='mb-2' key={i}>
                                    <NavLink className="f_size_18 f_500 p_color read_more_btn" to={`${item.url}`}>
                                        {item.text}
                                    </NavLink>
                                </li>
                            )
