            ...
            <div className="collapse navbar-collapse justify-content-end" id="OnePageManuContent">
                <ul className="navbar-nav ml-auto mr-3">
                    <li className="nav-item ">
                        <NavLink className="nav-link" activeclass="active" spy="true" offset={0} duration={500} to={'/services'}>
                            <Trans i18nKey="menu.services">services</Trans>
                        </NavLink>
                    </li>
                    <li className="nav-item ">
                        <NavLink className="nav-link" activeclass="active" spy="true" offset={0} duration={500} to={`/about`}>
                            <Trans i18nKey="menu.about">about</Trans>
                        </NavLink>
                    </li>
                    <li className="nav-item ">
                        <NavLink className="nav-link" activeclass="active" spy="true" offset={0} duration={500} to={`/contact`}>
                            <Trans i18nKey="menu.contact">contacts</Trans>
                        </NavLink>
                    </li>
                    <li className="nav-item">
                        <NavLink className="nav-link" activeclass="active" spy="true" offset={0} duration={500} to={`/dreamcoders`}>
                            Dreamcoders
                        </NavLink>
                    </li>
                </ul>
                <ul className="navbar-nav flex-direction-row justify-content-center">
                    ...
                    <li className='dropdown nav-item'>
                        <NavLink className="btn_get btn_hover" to={(location) => ({ ...location, pathname: '/careers' })}>
