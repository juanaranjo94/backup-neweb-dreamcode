...
function BannerGreatPlace() {
  ...
  return (
    <section className='great--place sec_pad'>
    <div className="container">
      <div className="great--content ">
        <Fade>
          <h2 className='position-relative line-break' >
            <Trans i18nKey="great-place.title_banner">
                The 99% of our <span>dreamcoders states</span>
              that we are <strong>one of the <span>greatest place</span>
              <span>to work</span></strong>
            </Trans>
          </h2>
        </Fade>
      ...
      <div className='d-flex align-items-center'>
          ...
          <h3 className='d_color '>
            <NavLink className='d_color f_size_30' activeclass="active" spy="true" offset={0} duration={500} to={`/great-place-to-work`}>
